...
# Choose which ensemble to use
USE_AUGMENTED = True   # True → augmented models, False → baseline models
...
output_file = f"results/ensemble_predictions_{model_tag}_{'test' if USE_TEST else 'val'}.csv"
